  ...
  return (
    <header>
      <nav id="navbar" className={scrolled ? 'scrolled' : ''} role="navigation" aria-label="Main navigation">
        <div className="container nav-inner">
          ...
          <div className="nav-actions">
            <a href="https://wa.me/919419000000?text=Hello%2C%20I%20want%20to%20plan%20my%20Kashmir%20trip!" className="nav-whatsapp" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp enquiry">
      ...
      <nav className={`nav-mobile ${mobileOpen ? 'open' : ''}`} id="mobile-menu" role="navigation" aria-hidden={!mobileOpen}>
        ...
        <a href="https://wa.me/919419000000" style={{ color: '#25D366', marginTop: '12px' }} target="_blank" rel="noopener noreferrer" className="mobile-link">💬 WhatsApp Enquiry</a>
      </nav>
    </header>
  );
};
