  ...
  <div className="container">
    ...
    <div className="packages-grid" id="packages-grid">
      {[
        ...
        { id:3, types:['family'],            ribbon:'⭐ Most Booked',         img:'images/family_tour.jpg',    imgAlt:'Kashmir Highlights',        type:'Classic Kashmir Itinerary', name:'Kashmir Highlights',        tags:['Srinagar','Gulmarg','Pahalgam'],                                dur:'5D / 4N', tripType:'Family / Couple',    group:'2 – 10',   rating:4.9, reviews:342, price:9500,  per:'per person · 4N5D', link:'/packages' },
