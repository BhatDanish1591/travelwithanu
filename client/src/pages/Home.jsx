...
<section id="packages" className="section-py" style={{ paddingTop: '80px' }} aria-labelledby="packages-heading">
  <div className="container">
    ...
    <div className="packages-grid" id="packages-grid">
      {[
        { id:1, types:['budget','family'],   ribbon:'💰 Pocket Friendly',    img:'images/dest_pahalgam.jpg',  imgAlt:'Kashmir Budget Explorer',   type:'Budget Kashmir Tour',    name:'Kashmir Budget Explorer',   tags:['Srinagar Stay','Pahalgam Day-trip'],                            dur:'4D / 3N', tripType:'Budget Group',       group:'4 – 15',   rating:4.6, reviews:201, price:7500,  per:'per person · 3N4D', link:'/packages' },
        { id:2, types:['luxury'],            ribbon:'❄️ Season Special',     img:'images/dest_gulmarg.jpg',   imgAlt:'Kashmir Winter Magic',      type:'Kashmir Winter Tour',    name:'Kashmir Winter Magic',      tags:['Gulmarg Snow','Houseboat','Srinagar'],                          dur:'4D / 3N', tripType:'Luxury Stay',        group:'2 – 6',    rating:4.7, reviews:98,  price:9500,  per:'per person · 3N4D', link:'/packages' },
        { id:3, types:['family'],            ribbon:'⭐ Most Booked',         img:'images/family_tour.jpg',    imgAlt:'Kashmir Highlights',        type:'Classic Kashmir Itinerary', name:'Kashmir Highlights',        tags:['Srinagar','Gulmarg','Pahalgam'],                                dur:'5D / 4N', tripType:'Family / Couple',    group:'2 – 10',   rating:4.9, reviews:342, price:8500,  per:'per person · 4N5D', link:'/packages' },
        { id:4, types:['family','luxury'],   ribbon:"🌟 Editor's Pick",      img:'images/autumn.jpg',         imgAlt:'Kashmir Escape',            type:'Premium Kashmir Tour',   name:'Kashmir Escape',            tags:['Srinagar','Gulmarg','Sonamarg','Pahalgam'],                     dur:'6D / 5N', tripType:'All Types',          group:'2 – 12',   rating:4.8, reviews:218, price:10500, per:'per person · 5N6D', link:'/packages' },
        { id:5, types:['adventure','budget'],ribbon:'⛺ Backpacker Choice',   img:'images/trekking.webp',      imgAlt:'Gurez Offbeat Explorer',    type:'Offbeat Kashmir Trek',   name:'Gurez Offbeat Explorer',    tags:['Gurez Dawar','Kishanganga','Wular Lake'],                       dur:'5D / 4N', tripType:'Adventure Trek',     group:'2 – 8',    rating:4.9, reviews:54,  price:10500, per:'per person · 4N5D', link:'/packages' },
        { id:6, types:['adventure'],         ribbon:'🏔️ Adventure',          img:'images/trekking.webp',      imgAlt:'Kashmir Adventure',         type:'Kashmir Adventure Tour', name:'Kashmir Adventure',         tags:['Gurez','Sonamarg','Gulmarg','Trekking'],                        dur:'7D / 6N', tripType:'Adventure',          group:'2 – 8',    rating:4.9, reviews:167, price:12000, per:'per person · 6N7D', link:'/packages' },
        { id:7, types:['family'],            ribbon:'👨‍👩‍👧 Family First',        img:'images/family_tour.jpg',    imgAlt:'Kashmir Family Delight',    type:'Kashmir Family Tour',    name:'Kashmir Family Delight',    tags:['Srinagar','Pahalgam','Gulmarg Gondola','Shikara Ride'],         dur:'7D / 6N', tripType:'Family Sightseeing', group:'3 – 12',   rating:4.8, reviews:134, price:12000, per:'per person · 6N7D', link:'/packages' },
        { id:8, types:['adventure','family'],ribbon:'🕉️ Pilgrimage',          img:'images/dest_pahalgam.jpg',  imgAlt:'Amarnath Yatra 2026',       type:'Amarnath Pilgrimage',    name:'Amarnath Yatra 2026',       tags:['Baltal','Pahalgam','Holy Cave'],                                dur:'4D / 3N', tripType:'Trek / Helicopter',  group:'1 – 20',   rating:4.9, reviews:512, price:18500, per:'per person',        link:'/amarnath-yatra', bookLink:'/amarnath-yatra/booking', ribbonStyle:{ background:'linear-gradient(135deg,#ea580c,#f59e0b)' } },
        { id:9, types:['honeymoon','luxury'],ribbon:'💑 Honeymoon',           img:'images/offbeat.png',        imgAlt:'Kashmir Honeymoon',         type:'Kashmir Honeymoon Package', name:'Kashmir Honeymoon',         tags:['Houseboat Stay','Shikara Ride','Gulmarg','Pahalgam'],           dur:'6D / 5N', tripType:'Couples Only',       group:'2 Persons',rating:5.0, reviews:456, price:23000, per:'per couple',        link:'/packages',       ribbonStyle:{ background:'linear-gradient(135deg,#e91e8c,#f43f5e)' } },
      ]
