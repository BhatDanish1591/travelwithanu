...
<nav id="navbar" role="navigation" aria-label="Main navigation">
  <div class="container nav-inner">
    <a href="index.html" class="nav-logo" aria-label="KashmirSafar home">
      <div class="nav-logo-mark" aria-hidden="true">🏔️</div>
      <div class="nav-logo-text">
        <div class="nav-logo-name">KashmirSafar</div>
    ...
    <div class="nav-actions">
      <a href="https://wa.me/919419000000?text=Hello%20KashmirSafar!" class="nav-whatsapp" target="_blank" rel="noopener" aria-label="WhatsApp">
      ...
      <a href="contact.html" class="nav-book-btn">Book Trip ✈️</a>
    </div>
...
<footer id="footer" role="contentinfo">
      ...
      <div class="footer-grid">
        <div class="footer-brand">
          <div class="footer-logo">
            <div class="footer-logo-mark">🏔️</div>
            <div>
              <div class="footer-logo-name">KashmirSafar</div>
  ...
  <div class="container">
    <div class="footer-bottom">
      <span>© 2025 KashmirSafar. All rights reserved. Made with ❤️ in Kashmir.</span>
...
<div class="fab-container">
  <a href="https://wa.me/919419000000?text=Hello%20KashmirSafar!" class="fab-whatsapp" target="_blank" rel="noopener" aria-label="WhatsApp">
